...
if int(indices_counter) == 0:
    print("No instances of " + wordle_word_1 + " found in " + wordle_word)

if int(indices_counter) == 1:
    print(str(indices_counter) + " instance of " + wordle_word_1 + " found in " + wordle_word)

if int(indices_counter) > 1:
    print(str(indices_counter) + " instances of " + wordle_word_1 + " found in " + wordle_word)